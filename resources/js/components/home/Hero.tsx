...
export default function Hero({ hero }:any) {
    ...
    return (
        <section className="relative min-h-150 flex items-center bg-[#fdfeff] pt-20 pb-16 overflow-hidden">
            
            {/* --- KREASI BACKGROUND BARU --- */}
            <div className="absolute inset-0 z-0 pointer-events-none">
                {/* Lingkaran Cahaya Utama (Animated) */}
                <div className="absolute top-[-20%] right-[-10%] w-200 h-200 bg-linear-to-br from-blue-200/40 to-purple-200/30 blur-[120px] rounded-full animate-pulse"></div>
                
                {/* Aksen Gradasi Lembut di Kiri Bawah */}
                <div className="absolute bottom-[-10%] left-[-5%] w-125 h-125 bg-linear-to-tr from-indigo-100/50 to-blue-50/20 blur-[100px] rounded-full"></div>

                {/* Pola Grid Halus Modern */}
                <div className="absolute inset-0 opacity-[0.4] mask-[radial-gradient(ellipse_at_center,black,transparent)]" 
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="relative">
                        <div className="relative z-10 group perspective-1000">
                            ...
                            <div className="absolute -inset-4 bg-linear-to-tr from-blue-500/10 to-purple-500/10 rounded-[3rem] rotate-3 group-hover:rotate-0 transition-all duration-700"></div>
                            ...
                            <div className="absolute -bottom-6 -left-6 bg-white/80 backdrop-blur-2xl p-5 rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.1)] border border-white/50">
                                <div className="flex items-center gap-4">
                                    <div className="p-3 bg-linear-to-br from-blue-600 to-indigo-700 rounded-2xl shadow-lg text-white">
